// ver1.1_26.02.22
// Shared CSS packs for Herma lesson runtimes.
// Injects stable, repeated UI styles once and lets each lesson keep its custom overrides.
(function initHermaStylePacks(global) {
  if (!global || global.hermaStylePacks) return;
  ...
  function ensureOne(name) {
    ...
    style.setAttribute("data-herma-style-pack", name);
