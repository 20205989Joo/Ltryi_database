...
(function () {
    ...
    if (answerLineEl) {
      ...
      if (!selectedTokens.length) {
        ...
        selectedTokens.forEach((tok, idx) => {
          ...
          sp.style.cursor = isLocked ? "not-allowed" : (isLast ? "pointer" : "default");
          sp.style.opacity = isLocked ? "0.6" : "1";
  ...
  window.pleksKRScramble = window.PleksKRScramble;
  window.pleksScramble = window.PleksScramble;
})();
